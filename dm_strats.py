#coding=utf-8
from dm_data import DataRepository
...
class Strategy(object):
    ...
    def get_stock_position(self, code, date=today):
        return self.position_list[code][date]
    ##To be finished

    def get_stock_period_position(self, code, startdate, enddate)
        return self,position_list[code, startdate, enddate]
    ##To be finished

    def get_stock_value(self, code, date=today):
        stock_value = get_stock_position(code, date) * get_stock_close_price(code, date)
        return self,stock_value

    def get_stock_period_value(self, code, startdate, enddate)
        return self,position_list[code, startdate, enddate]* get_stock_period_close_price(code, startdate, enddate)
    ##To be finished
